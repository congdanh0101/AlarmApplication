...
public class CountdownTimerAcitivity extends AppCompatActivity {
...
//        START_IN_TIME_MILLIS = bundle.getLong(getString(R.string.time_millis_second));
////        START_IN_TIME_MILLIS = getIntent().getExtras().getLong(getString(R.string.time_millis_second));
